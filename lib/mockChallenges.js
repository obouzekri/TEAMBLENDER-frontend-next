...
const BASE_MOCK_CHALLENGES = [
  {
    ...
    engine_config: {
      ...
      rules: {
        ...
        participant: {
          fr: [...PIXEL_RULES_FR.participant],
          en: [...PIXEL_RULES_EN.participant],
        },
        footnote: {
  ...
  },
  {
    ...
    engine_config: {
      ...
      rules: {
        ...
        participant: {
          fr: [...COPUZZLE_RULES_FR.participant],
          en: [...COPUZZLE_RULES_EN.participant],
        },
        footnote: {
  ...
  },
  {
    ...
    engine_config: {
      ...
      rules: {
        ...
        participant: {
          fr: [...QUIZ_RULES_FR.participant],
          en: [...QUIZ_RULES_EN.participant],
        },
        footnote: {
  ...
  },
  {
    ...
    engine_config: {
      ...
      rules: {
        ...
        participant: {
          fr: [...PHRASE_RULES_FR.participant, ...PHRASE_RULES_FR.hints],
          en: [...PHRASE_RULES_EN.participant, ...PHRASE_RULES_EN.hints],
        },
        footnote: {
  ...
  },
  {
    ...
    engine_config: {
      ...
      rules: {
        ...
        participant: {
          fr: [...VOM_RULES_FR.participant],
          en: [...VOM_RULES_EN.participant],
        },
        footnote: {
  ...
  },
  {
    ...
    engine_config: {
      ...
      rules: {
        ...
        objective: {
          fr: MISSION_RULES_FR.objective,
          en: MISSION_RULES_EN.objective,
        },
        facilitator: {
          fr: MISSION_RULES_FR.facilitator,
          en: MISSION_RULES_EN.facilitator,
        },
        participant: {
          fr: [...MISSION_RULES_FR.participant],
          en: [...MISSION_RULES_EN.participant],
        },
        footnote: {
          fr: MISSION_RULES_FR.footnote,
          en: MISSION_RULES_EN.footnote,
        },
      },
    },
  },
