  ...
  },
  {
    ...
    engine_config: {
      ...
      rules: {
        ...
        participant: {
          fr: [...LABYRINTHE_RULES_FR.participant, ...LABYRINTHE_RULES_FR.scoring],
          en: [...LABYRINTHE_RULES_EN.participant, ...LABYRINTHE_RULES_EN.scoring],
        },
        footnote: {
  ...
  },
  {
    ...
    engine_config: {
      ...
      rules: {
        ...
        participant: {
          fr: [...MISSION_RULES_FR.participant, ...MISSION_RULES_FR.scoring],
          en: [...MISSION_RULES_EN.participant, ...MISSION_RULES_EN.scoring],
        },
        footnote: {
