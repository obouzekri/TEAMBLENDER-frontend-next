...
function resolveSocketTuning() {
  return {
    // Railway cold starts / edge latency can exceed 12s; give the first attempt more room
    // before engine.io reports a transport-level failure (e.g. "xhr poll error").
    connectTimeoutMs: parseEnvInt(process.env.NEXT_PUBLIC_SOCKET_CONNECT_TIMEOUT_MS, 20000, 3000, 60000),
