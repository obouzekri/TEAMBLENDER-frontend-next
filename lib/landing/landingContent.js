...
export const LANDING_STATIC_BY_LOCALE = {
  fr: {
    ...
    platformBenefitsItems: [
      { icon: Handshake, label: 'Cohésion renforcée dans les équipes hybrides', description: 'Créez des liens plus forts entre les collaborateurs à distance et sur site.' },
      { icon: MessageCircle, label: 'Meilleure communication et collaboration', description: 'Gardez les équipes alignées grâce à des expériences partagées et engageantes.' },
      { icon: GraduationCap, label: 'Onboarding accéléré', description: 'Aidez les nouvelles recrues à s’intégrer rapidement et en confiance.' },
      { icon: ClipboardList, label: 'Gain de temps pour RH et managers', description: 'Automatisez les tâches répétitives et réduisez les relances manuelles.' },
      { icon: Sparkles, label: 'Expérience collaborateur modernisée', description: 'Offrez un parcours collaborateur cohérent et engageant.' },
    ],
    useCases: [
    ...
    fallback: {
      ...
      liveExperience: 'Expérience de team building interactive',
      liveLabel: 'En direct',
  ...
  en: {
    ...
    platformBenefitsItems: [
      { icon: Handshake, label: 'Stronger cohesion in hybrid teams', description: 'Build stronger relationships across remote and onsite employees.' },
      { icon: MessageCircle, label: 'Better communication and collaboration', description: 'Keep teams aligned through shared experiences and engagement.' },
      { icon: GraduationCap, label: 'Faster onboarding', description: 'Help new hires integrate quickly and confidently.' },
      { icon: ClipboardList, label: 'Time saved for HR and managers', description: 'Automate repetitive tasks and reduce manual follow-up.' },
      { icon: Sparkles, label: 'Modernized employee experience', description: 'Deliver a consistent and engaging employee journey.' },
    ],
    useCases: [
