  ...
  challengeRules: {
    labyrintheSignals: {
      ...
      scoring: [
        ...
        'Progression : +8 points par case sécurisée avancée par l\'équipe.',
        'Survie : +2 points par vie restante en fin de partie.',
        'Risque : -12 points par vie perdue.',
        'Plancher de score : le total final ne peut pas descendre en dessous de 0.'
      ],
      footnote: ''
    },
    pariSurMoi: {
    ...
    labInnovation: {
      ...
      subtitle: 'Faites émerger une solution innovante à partir de l\'intelligence collective.',
      objective: 'Faites émerger une solution innovante à partir de l\'intelligence collective de l\'équipe.',
      participants: {
        min: '3 joueurs',
      ...
      facilitator: [
        'Le challenge enchaîne 4 phases automatiques : problématiques, solutions, argumentaire puis vote final.',
        'Surveillez le temps et laissez la progression s\'exécuter naturellement entre les phases.',
        'Chaque phase réutilise le système de votes, de classement, de badges et de live updates existant.'
      ],
      participant: [
        'Phase 1 : proposez jusqu\'à 2 problématiques, 200 caractères maximum.',
        'Phase 1 : votez sur les problématiques sans voter pour les vôtres.',
        'Phase 2 : proposez jusqu\'à 2 solutions reliées au Top 4.',
        'Phase 2 : votez sur les solutions sans voter pour les vôtres.',
        'Phase 3 : enrichissez les solutions finalistes avec un argumentaire structuré.',
        'Phase 4 : vote final anonyme sur la meilleure solution.',
        'Le score cumule la participation, les contributions, les votes qualifiés et la présence sur les 4 phases.'
      ],
      scoring: [
      ...
      footnote: 'Les 4 phases sont automatiques, chronométrées et live.'
    },
    escapeRoom: {
    ...
    phraseMystere: {
      ...
      participant: [
        ...
        'Certaines propositions sont des faux mots (leurres).',
    ...
    CoPuzzle: {
      ...
      participant: [
        'Chaque pièce est numérotée pour faciliter les échanges entre participants.',
        'Chaque participant dispose d’un ensemble de pièces à placer.',
        'Positionnez vos pièces aux emplacements les plus pertinents.',
        'Les pièces posées sont visibles par toute l’équipe, y compris leur numéro.',
    ...
    labInnovation: {
      ...
      objective: 'Faites émerger une solution solide en 4 phases coordonnées, de l\'exploitation du problème jusqu\'au vote final.',
      participants: {
        min: '3 joueurs',
        recommended: '6 joueurs',
        max: '12 joueurs'
      ...
      facilitator: [
        'Vérifier que tous les participants sont prêts.',
        'Lancer le chronomètre.',
        'Guider la transition entre les 4 phases.',
        'Faire respecter les temps de prise de parole et de vote.'
      ],
      participant: [
        'Décrivez clairement le problème à traiter.',
        'Proposez une solution concise et concrète.',
        'Défendez votre solution avec des arguments utiles au groupe.',
        'Votez pour la proposition la plus solide et la plus réaliste.'
      ],
      scoring: [
        'Soumission d\'une problématique : +10 points.',
        'Problématique dans le Top 4 : +30 points.',
