const fr = {
  ...
  challengeRules: {
    ...
    labInnovation: {
      ...
      scoring: [
        'Les contributions utiles renforcent la qualité de la solution finale.',
        'Le vote final détermine la proposition retenue par l’équipe.',
        'Le challenge est réussi lorsque l’équipe choisit une solution commune et actionnable.'
      ],
      footnote: ''
    }
  }
