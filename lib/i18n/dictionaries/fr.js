const fr = {
  ...
  sessionBuilder: {
    participantsOptionalHint: 'Vous pouvez créer la session maintenant, puis ajouter ou inviter des participants ensuite.',
    participantsCanBeAddedLater: 'Participants à ajouter plus tard',
    participantsCanBeAddedLaterBody: 'La session peut être créée dès maintenant. Vous pourrez ensuite assigner des participants, envoyer des invitations et partager le code d’accès.',
  ...
  sessionBuilder: {
    ...
    noParticipantsAvailableBody: 'Créez d\'abord des participants dans l\'espace manager. La création de session est disponible après cette étape.',
