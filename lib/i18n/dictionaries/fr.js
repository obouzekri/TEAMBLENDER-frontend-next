const fr = {
  ...
  sessionBuilder: {
    ...
    stepperAria: 'Etapes de creation de session',
    stepFrame: 'Cadre',
    stepParticipants: 'Participants',
    stepConfirmation: 'Confirmation',
    stepCurrent: 'Etape en cours',
    stepCompleted: 'Etape terminee',
    stepUpcoming: 'Etape a venir',
    timezoneLabel: 'Fuseau detecte : {timezone}',
    timezoneUnknown: 'Fuseau detecte : inconnu',
    ...
    participantsRequired: 'Aucun participant selectionne.',
    participantsAvailable: '{count} participant(s) disponible(s)',
    selectedSummaryTitle: 'Resume des participants selectionnes',
    noSelectionSummary: 'Aucun participant selectionne pour le moment.',
    confirmationTitle: 'Verifier avant creation',
    confirmationBody: 'Confirmez les informations de votre session avant de creer.',
    next: 'Suivant',
    back: 'Retour',
    createParticipant: 'Creer un participant',
    createParticipantCta: 'Creer un participant',
    unsavedChangesWarning: 'Des modifications non enregistrees existent. Voulez-vous quitter cette page ?',
    draftSaved: 'Brouillon enregistre automatiquement.',
    draftRestored: 'Brouillon restaure apres rechargement.',
    launchConfirmTitle: 'Confirmer le lancement',
    launchConfirmBody: 'Une fois la session lancee, la configuration ne pourra plus etre modifiee.',
    launchConfirmAction: 'Confirmer',
    launching: 'Lancement...',
    participantSelectionUpdated: 'Selection des participants mise a jour ({count}).',
    participantSearchResults: '{count} resultat(s)',
    noParticipantsFound: 'Aucun participant trouve',
    noParticipantsFoundBody: 'Modifiez votre recherche ou creez un participant.',
    noParticipantsAvailable: 'Aucun participant disponible',
    noParticipantsAvailableBody: 'Creez d\'abord des participants dans l\'espace manager. La creation de session est disponible apres cette etape.',
    searchParticipantsPlaceholder: 'Rechercher par nom ou email',
    selectAll: 'Tout selectionner',
    deselectAll: 'Tout deselectionner',
    selectedCountDetailed: '{count} participant(s) selectionne(s)',
    rowCheckboxLabel: 'Selectionner {name}',
