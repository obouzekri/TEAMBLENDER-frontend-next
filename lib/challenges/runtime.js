...
const engineRegistry = {
  ...
  'lab_d_innovation_v1': {
    ...
    component: () => import('@/components/Challenges/LabDInnovation/LabDInnovationChallenge'),
    description: 'Idéation collaborative en 4 phases'
  },
  'mission_critique_v1': {
    name: 'Mission Critique',
    component: () => import('@/components/Challenges/MissionCritique/MissionCritiqueChallenge'),
    description: 'Construisez une timeline projet sous contraintes de dependances'
  },
  'the_quiz_v1': {
    name: 'The Quiz',
    component: () => import('@/components/Challenges/TheQuiz/TheQuizChallenge'),
    description: 'Quiz multijoueur realtime de culture generale'
  },
  'vrai_ou_mensonge_v1': {
    name: 'Pari sur moi !',
    component: () => import('@/components/Challenges/VraiOuMensonge/VraiOuMensongeChallenge'),
    description: 'Un participant pose, les autres votent, puis revelation et score'
  },
  'pixel_architect_v1': {
    name: 'Pixel Architect',
    component: () => import('@/components/Challenges/PixelArchitect/PixelArchitectChallenge'),
    description: 'Construisez une structure 3D collaborative sous contraintes'
  }
};
