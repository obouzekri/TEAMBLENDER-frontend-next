...
export default function HomePage() {
  ...
  const glassCardClass = 'rounded-3xl border border-[color:var(--surface-soft-border)] bg-[color:var(--surface-panel)] shadow-sm backdrop-blur-md transition-all duration-200 hover:-translate-y-1 hover:shadow-xl';
  ...
  const chipClass = 'inline-flex items-center gap-2 rounded-full border border-[color:var(--surface-soft-border)] bg-[color:var(--surface-panel)] px-4 py-2 text-sm font-medium text-[color:var(--ink-soft)] shadow-sm backdrop-blur-md transition-all duration-200 ease-in-out hover:-translate-y-0.5 hover:border-[color:var(--surface-soft-border-strong)] hover:bg-[color:var(--surface-panel-soft)] hover:shadow-md';
