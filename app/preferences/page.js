...
export default function PreferencesPage() {
  ...
  function savePreferences() {
    showSuccess('Preferences enregistrees.');
  }
    ...
    return (
      <main className="shell auth-page">
        <section className="feature-card">
          <h1>Chargement des preferences</h1>
          <p>Preparation de vos reglages personnels.</p>
        </section>
      </main>
    );
  }
  ...
  return (
    <>
      ...
      <main className="shell app-home preferences-page">
        <section className="preferences-page-header" aria-label="En-tete des preferences">
          <p className="eyebrow">PREFERENCES</p>
          <h1>Preferences</h1>
          <p>Personnalisez les notifications, l'apparence et les reglages d'experience de TeamBlender.</p>
        </section>
        ...
        <section className="preferences-panel" aria-labelledby="preferences-notifications-title">
          <header className="preferences-panel__header">
            ...
            <p>Choisissez les rappels et resumes que vous souhaitez recevoir.</p>
          </header>
          <div className="preferences-panel__body">
            <label className="preferences-toggle">
              <span>
                <strong>Rappels de session</strong>
                <small>Recevoir un rappel avant les sessions planifiees.</small>
              </span>
            ...
            <label className="preferences-toggle">
              <span>
                <strong>Resumes d'activite</strong>
                <small>Recevoir une synthese des activites recentes.</small>
              </span>
              <span className="preferences-toggle__switch">
        ...
        <section className="preferences-panel" aria-labelledby="preferences-appearance-title">
          <header className="preferences-panel__header">
            ...
            <p>Ajustez le confort visuel et la densite de l'interface.</p>
          </header>
          <div className="preferences-panel__body">
            <label className="preferences-toggle">
              <span>
                <strong>Navigation compacte</strong>
                <small>Reduire l'espace occupe par la barre de navigation.</small>
              </span>
              <span className="preferences-toggle__switch">
            ...
            <label className="preferences-toggle">
              <span>
                <strong>Contraste renforce</strong>
                <small>Augmenter la lisibilite des textes secondaires.</small>
              </span>
              <span className="preferences-toggle__switch">
        ...
        <section className="preferences-panel" aria-labelledby="preferences-personalization-title">
          <header className="preferences-panel__header">
            ...
            <p>Ces reglages accueilleront les futures preferences d'experience et de facilitation.</p>
          </header>
          <div className="preferences-panel__body preferences-panel__body--muted">
            <p>Les preferences avancees seront ajoutees progressivement sans melanger les reglages d'experience avec le profil, la securite ou la facturation.</p>
          </div>
        </section>

        <div className="preferences-actions">
          <button type="button" className="btn-primary" onClick={savePreferences}>Enregistrer les preferences</button>
        </div>
      </main>
      <Footer />
